...
export const newProducts: NewProduct[] = [
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/aventurine-enmusubi.jpg',
    mysteryLevel: 8,
    stock: 5,
    category: '天然石お守り',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/motherofpearl-omamori.jpg',
    mysteryLevel: 7,
    stock: 8,
    category: '天然石お守り',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/onyx-beauty.jpg',
    mysteryLevel: 8,
    stock: 3,
    category: '天然石お守り',
    slug: 'onyx-beauty',
  ...
  // ミューラムテクノロジーシリーズ
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/muse-rack-pendant.jpg',
    mysteryLevel: 10,
    stock: 1,
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/mue-lamp.jpg',
    mysteryLevel: 10,
    stock: 20,
    category: 'ミューラムテクノロジー',
    slug: 'mue-lamp',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/mue-onram.jpg',
    mysteryLevel: 10,
    stock: 100,
    category: 'ミューラムテクノロジー',
    featured: true,
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/muse-rax.jpg',
    mysteryLevel: 9,
    stock: 100,
    category: 'ミューラムテクノロジー',
    slug: 'muse-rax',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/exa-rainbow-zero.jpg',
    mysteryLevel: 10,
    stock: 50,
    category: 'ミューラムテクノロジー',
    featured: true,
  ...
  // イヤシロチシリーズ
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/iyashirochi-aroma.jpg',
    mysteryLevel: 7,
    stock: 50,
    category: 'イヤシロチシリーズ',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/iyashirochi-alpha.jpg',
    mysteryLevel: 8,
    stock: 200,
    category: 'イヤシロチシリーズ',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/iyashirochi-powder.jpg',
    mysteryLevel: 9,
    stock: 30,
    category: 'イヤシロチシリーズ',
    featured: true,
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/internatural-sp.jpg',
    mysteryLevel: 9,
    stock: 20,
    category: 'イヤシロチシリーズ',
  ...
  // 高額スペシャルアイテム
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/ari-medick-god.jpg',
    mysteryLevel: 10,
    stock: 1,
    category: 'スペシャルアイテム',
    featured: true,
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/brain-refresher.jpg',
    mysteryLevel: 10,
    stock: 5,
    category: 'スペシャルアイテム',
    featured: true,
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/home-sauna-kiwami.jpg',
    mysteryLevel: 10,
    stock: 3,
    category: 'スペシャルアイテム',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/hydrogen-generator.jpg',
    mysteryLevel: 10,
    stock: 2,
    category: 'スペシャルアイテム',
    featured: true,
  ...
  // その他の商品（一部抜粋）
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/dragon-salt.jpg',
    mysteryLevel: 6,
    stock: 100,
    category: 'その他',
    slug: 'dragon-salt',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/sleep-sheet.jpg',
    mysteryLevel: 7,
    stock: 50,
    category: 'その他',
    slug: 'sleep-sheet',
  ...
  },
  {
    ...
    images: ['/images/placeholder.jpg', // original: '/images/products/enzyme-infinity.jpg',
    mysteryLevel: 8,
    stock: 30,
    category: 'その他',
